...
## 🚧 Caution: it's easy for animation to make a good plot worse!
...
# Think about why you want to animate?
...
.right-plot[
```{r gm-output2, ref.label="gm-plot2", echo=FALSE, cache=TRUE, fig.height = 10}
```
]
...
`r icon_style(fontawesome$solid$desktop, fill = "white")` Review slides: [mitchelloharawild.com/wombat-gganimate](https://mitchelloharawild.com/wombat-gganimate)
