...
### 23 September 2021
### Slides @ [slides.mitchelloharawild.com/OnePackagePerMeetup-gganimate](https://slides.mitchelloharawild.com/OnePackagePerMeetup-gganimate)
]
...
.animated.rubberBand[
.desc[OnePackagePerMeetup - Tunis R User Group]
]
...
tsibbledata::vic_elec %>% 
  filter(yearmonth(Time) == yearmonth("2014 June")) %>% 
  ggplot(aes(x = Time, y = Demand)) + 
  geom_line() + 
